...
/**
 * A factory to get
 * <code>SqlEncuestaDao</code> objects. <p> Required configuration parameters: <ul>
 * <li><code>SqlEncuestaDaoFactory.className</code>: it must specify the full class
 * name of the class implementing
 * <code>SqlEncuestaDao</code>.</li> </ul>
 */
